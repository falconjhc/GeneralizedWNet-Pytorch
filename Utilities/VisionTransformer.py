...
class VisionTransformer(nn.Module):
    def __init__(self, image_size, patch_size, num_layers,  d_model, num_heads, mlp_dim, patchDim, dropout=0.1):
        ...
        # self.class_emb = nn.Parameter(torch.zeros(1, 1, d_model))
    ...
    def forward(self, x):
        ...
        # class_emb = self.class_emb.expand(batch_size, -1, -1)
...
class PatchMerging(nn.Module):
    def __init__(self, dim, dim_scale=2):
        ...
        # nn.Linear expects (in_features, out_features), and we're following the equivalent logic
