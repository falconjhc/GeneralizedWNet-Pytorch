...
hyperParams = {
        'debugMode': 0,
        'expID':'20240501-ContentPF64-StylePF50-DP',# experiment name prefix
        'expDir': '/data-shared/server02/data1/haochuan/Character/TrainRecords-202405/',
        ...
        'augmentTranslationRotation':1, # translation? rotation?
        'augmentFlip':0,
        'inputStyleNum':5, 
